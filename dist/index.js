(function (factory) {
    ...
    exports.decode = exports.parseValue = void 0;
    ...
    const isBuffer = (value) => value && typeof Buffer !== "undefined" && Buffer.isBuffer(value);
    const isReadStream = (value) => value && typeof require === "function" && value instanceof require("fs").ReadStream;
    const isFile = (value) => isBuffer(value) ||
        isReadStream(value) ||
        (isBlob(value) &&
